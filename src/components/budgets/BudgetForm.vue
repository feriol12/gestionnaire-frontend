...
<template>
  ...
  >
    ...
    <div
      class="bg-white rounded-2xl shadow-modal w-full max-w-md"
    >
      ...
      <div class="p-5 space-y-4">
        ...
        <div>
          ...
          <label
            class="block text-[13px] font-medium text-slate-500 mb-1"
          >
            Montant (FCFA)
      ...
      <!-- ACTIONS -->
      <div
        class="flex justify-end gap-3 p-5 border-t border-slate-100"
      >
